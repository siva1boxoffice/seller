...
define('THEME_NAME',			'BLUE_THEME');
define('ADMIN_UPLOAD',					'https://www.listmyticket.com');
define('LOGS_DOWNLOAD',					'https://listmyticket.com/1bx/sellerapi/');
define('FULLFILLMENT_DAY',					3);
