  ...
  <table class="table">
            ...
            ?>
              <tr>
                ...
                <td><span>Tickets sold:&nbsp;</span><?php echo $list_ticket->sold_qty;?></td>
                <td><span>Pending Fulfillment:&nbsp;</span> <?php echo $list_ticket->pending_fullfillment;?></td>
                <td><?php echo $event_left;?></td>
                <td></td>
              </tr>
            <?php } ?>
            </table>
            <table class="table toptable_new">
              <tr>
                <th>&nbsp;</th>
...
'</span></div>');*/
    ...
    //$('.ticket_clone').on('click',function(){
      ...
      $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>tickets/index/get_ticket_oe',
            data: {
               'ticket_id': ticket_id,
               'type': 'clone'
            },
