               ...
               <?php } ?></span>
                              ...
                              <!-- <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                  <span class="input-group-text" id="basic-addon1">
                                    <?php if (strtoupper($list_ticket->price_type) == "GBP") { ?>
                                    <img src="<?php echo base_url().THEME_NAME;?>/images/pound.svg">
                                    <?php } ?>
                                    <?php if (strtoupper($list_ticket->price_type) == "EUR") { ?>
                                  <img src="<?php echo base_url().THEME_NAME;?>/images/euro.svg"></span>
                                    <?php } ?>
                              ...
                              <div class="col-md-12">
                                <div class="select_option">
                                  <div class="sel_detail_lft">
                                    ...
                                    ?>
                                    <li><input class="ticket_label tdcheckbox" type="checkbox" name="ticket_details[]" value="<?php echo $ticket_detail->id; ?>" <?php if (in_array($ticket_detail->id, $listing_notes)) { ?> checked <?php } ?>>
                                ...
                                <!-- <div class="select_option">
                                  <ul>
                                    ...
                                    foreach ($restriction_left as $ticket_detail) { 
                                    ?>
                                    <li><input class="tdcheckbox" type="checkbox" name="ticket_details[]" value="<?php echo $ticket_detail->id; ?>" <?php if (in_array($ticket_detail->id, $listing_notes)) { ?> checked <?php } ?>> <?php echo $ticket_detail->ticket_det_name; ?></li>
                                  <?php $ticket_key++;} ?>
